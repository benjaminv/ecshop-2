...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	public function actionCollectionList()
	{
		if (IS_AJAX) {
			...
			$size = 10;
			$collection_goods = get_collection_goods($this->user_id, $size, $page);
			exit(json_encode(array('goods_list' => $collection_goods['goods_list'], 'totalPage' => $collection_goods['totalpage'])));
		}
