...
function category_get_goods($children, $intro = '', $brand, $user_id, $sort = '', $warehouse_id = 0, $area_id = 0, $limit = 10, $area_city = 0)
{
	...
	foreach ($res as $row) {
		...
		if($row['sales_volume_base']>0){
			$arr[$row['goods_id']]['sale'] = $row['sales_volume']+$row['sales_volume_base'];
		}else{
